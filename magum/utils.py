...
def _dataConvertion(Object, sensor, axisList, uM=None):
    if sensor == 'a':
        ...
        # degrees
            ...
            print 'Error: Invalid measure unit given to method _dataConvertion(Object,sensor,axisList,uM=None) for ' \
				  'accelerometer'
            sys.exit(1)
    ...
    if sensor == 'g':
        ...
        if uM in (None, 'raw'):
            ...
            elif currScale % 2 != 0 and (
                currScale + 1) % 4 == 0:  # last two bits are setted to 0b01 (+/- 1000/2000 mode)
